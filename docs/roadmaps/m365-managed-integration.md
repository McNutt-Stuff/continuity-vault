...
- [ ] P6 broader sources (Copilot ✓, Calendar ✓, Contacts ✓, OneNote ✓; Planner/To Do, Viva next) + enterprise customer-owned app + direct restore
