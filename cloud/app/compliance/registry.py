    ...
    "nist_csf": {
        ...
        "controls": [
            ...
            {"id": "PR.AA-05", "title": "Least-privilege access", "family": "Protect",
             "capabilities": ["access_control", "mfa", "conditional_access", "phishing_resistant_mfa", "privileged_mfa", "privileged_access_review"],
    ...
    "cis": {
        ...
        "controls": [
            ...
            {"id": "6.3", "title": "Require MFA", "family": "Access control",
             "capabilities": ["mfa", "conditional_access", "phishing_resistant_mfa", "privileged_mfa", "privileged_access_review"], "guidance": "Require MFA + conditional access for privileged access."},
    ...
    "hipaa": {
        ...
        "controls": [
            ...
            {"id": "164.312(a)(1)", "title": "Access control", "family": "Technical",
             "capabilities": ["access_control", "mfa", "conditional_access", "external_sharing_control", "phishing_resistant_mfa", "privileged_mfa", "privileged_access_review", "guest_access"], "guidance": "Restrict ePHI access."},
