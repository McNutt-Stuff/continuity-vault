"""Qualys compliance driver — maps Qualys posture to Arkive compliance capabilities.
...
# compliance capability -> how Qualys evidences it.
CAPABILITIES: dict[str, str] = {
    "vulnerability_management": 'Authenticated scan coverage + open findings by severity and SLA adherence.',
}

register_shell_driver("qualys", CAPABILITIES)
