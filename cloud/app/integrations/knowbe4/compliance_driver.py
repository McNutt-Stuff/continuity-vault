"""KnowBe4 compliance driver — maps KnowBe4 posture to Arkive compliance capabilities.
...
# compliance capability -> how KnowBe4 evidences it.
CAPABILITIES: dict[str, str] = {
    "security_training": 'Security-awareness training completion + phishing-test results across the workforce.',
}

register_shell_driver("knowbe4", CAPABILITIES)
