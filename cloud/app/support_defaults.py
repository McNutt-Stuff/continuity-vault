...
_SOURCE_PAGES = [
    ...
    _source_doc(
        ...
        extra=(
            ...
            "place / not applicable), add a note, link your proof (a policy document or URL), and set a "
            "review date. Answers are audited and re-scored immediately; an attestation past its review "
